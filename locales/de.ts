export default {
  "about.me.heading": "Hallo, ich bin Zoe!",
  "about.me.description":
    "Ich studiere Software-System-Entwicklung an der Universität Hamburg und lerne gern neues über Technologie.",
  skills: "was ich so mache",
  projects: "Projekte",
  "avatar.alt":
    "eine Person in einem schwarzen Kleid steht vor Leinwand, auf die bunte lichter scheinen",
  "cv.link": "CV-DE.pdf",
  "cv.name": "Lebenslauf",
  "to-top": "nach oben",
  ...
  "backend-web-development.description":
    "Das Frontend braucht natürlich auch ein Backend.\
    Die Geschwindigkeit und Sicherheit von Rust und die schnelle und einfache Entwicklung mit Typescript oder Go faszinierien mich beide.",
  ...
  homelab: "Homelab",
  "homelab.description":
    "Seit 2019 betreibe ich ein Homelab und hoste von\
  dort aus einige verschiedene Services wie Nextcloud,\
  Gitea, und Wordpress. Einige selbst geschriebene\
  Services gehören auch dazu.",
